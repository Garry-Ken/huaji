...
const FOOD_LEADING_RE = /^(?:今天|昨天|前天|明天|早上|早晨|上午|中午|下午|午后|傍晚|晚上|今晚|昨晚|凌晨|和|跟|与|及|在|去|到|的|了|还|又|再|顿|份|聚餐|聚会|早茶|早点|早饭|午饭|中饭|晚饭|正餐|大餐|宵夜|夜宵|加餐|下午茶|办酒席|请客|请|约了?|和家人|和朋友|和同事|跟家人|跟朋友|跟同事|吃了?顿?饭?|喝了?水?|点了?|买了?|来了?|整了?|搞了?|煮了?|做了?|烤了?|炸了?|蒸了?|炒了?|啃了?|嗑了?|嚼了?|[一二两三四五六七八九十几半\d]+\s*(?:份|碗|杯|个|只|盒|袋|瓶|块|片|盘|包|桶|罐|条|把|颗|粒|串|根|口|桌|顿))+/
