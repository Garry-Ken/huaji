...
export const SearchIcon = (p: P) => (<S {...p}><circle cx="11" cy="11" r="7" /><path d="M21 21l-4.35-4.35" /></S>)
export const UploadIcon = (p: P) => (<S {...p}><path d="M12 15V3m0 0l-4 4m4-4l4 4M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2" /></S>)
export const ShieldIcon = (p: P) => (<S {...p}><path d="M12 2l8 4v5c0 5.5-3.4 10.7-8 12-4.6-1.3-8-6.5-8-12V6l8-4Z" /></S>)
export const RefreshIcon = (p: P) => (<S {...p}><path d="M3 12a9 9 0 0 1 15-6.7L21 8M21 12a9 9 0 0 1-15 6.7L3 16" /><path d="M21 3v5h-5M3 21v-5h5" /></S>)
export const TargetIcon = (p: P) => (<S {...p}><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="5" /><circle cx="12" cy="12" r="1" /></S>)
export const InfoIcon = (p: P) => (<S {...p}><circle cx="12" cy="12" r="9" /><path d="M12 16v-4M12 8h.01" /></S>)
